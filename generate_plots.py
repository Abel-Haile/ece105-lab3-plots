...
def plot_scatter(sensor_a, sensor_b, timestamps, ax):
    """Draw a scatter plot of sensor readings versus time.
    ...
    None
    """
    ax.scatter(timestamps, sensor_a, color='blue', alpha=0.7, label='Sensor A')
    ax.scatter(timestamps, sensor_b, color='orange',
               alpha=0.7, label='Sensor B')
...
def plot_histogram(sensor_a, sensor_b, ax):
    ...
    None
    """
    ax.hist(sensor_a, bins=20, alpha=0.5, color='blue', label='Sensor A')
    ax.hist(sensor_b, bins=20, alpha=0.5, color='orange', label='Sensor B')
